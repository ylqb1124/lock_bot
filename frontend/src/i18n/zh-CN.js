export default {
  ...
  botCreate: {
    ...
    defaultDurationUnit: '小时',
    defaultDurationHelp: '用户未指定时长时的默认值，单位小时，默认 2 小时',
    maxLockDuration: '最大锁定时长',
    maxLockDurationHelp: '允许的最长锁定时间，单位小时，-1 表示不限制',
    maxLockDurationUnlimited: '不限制（-1）',
    unlimited: '不限制',
    hours: '小时',
    minutes: '分钟',
    seconds: '秒',
    maxLockDurationWarning: '超过 24 小时可能导致资源长期占用',
    ...
    weekdaySun: '周日',
    policyEveryDay: '每天',
    lockPolicyDurationHours: '最长时长（小时）',
    addLockPolicy: '添加时间策略',
    removeLockPolicy: '删除时间策略',
    invalidLockPolicyTime: '策略时间段无效或起止时间相同',
    invalidLockPolicyCount: '策略机器数必须为 -1 或 1-16',
    invalidLockPolicyDuration: '策略最长时长必须为 -1 或 0.1-168 小时',
    invalidLockPolicyWeekdays: '请至少选择一个不重复的适用星期',
    overlappingLockPolicies: '策略时间段不能重叠',
    forbidRelock: '禁止续锁',
  ...
  publicReport: {
    ...
    container: '容器名',
    live: '实时报告',
    machineReport: '机器状态报告',
    summary: '资源汇总',
    totalHint: '已纳入公开状态报告',
    unlockedHint: '占全部资源的 {percent}%',
    unoccupiedHint: '无 lock 或 book，占全部资源的 {percent}%',
    soonHint: '仅统计有明确释放时间的资源',
    gpuFreeHint: '显存可用占比 {percent}%',
    quickView: '快速查看',
    availabilityOverview: '可用资源一览',
    resourceUsageOverview: '资源占用一览',
    resourcesTracked: '共追踪 {count} 个资源',
    availableList: '现在可占用',
    availableListHint: '未锁定的资源，可直接申请',
    soonList: '即将可用',
    soonListHint: '预计在 2 小时内释放',
    noAvailable: '当前没有立即可用的资源',
    noSoon: '暂无 2 小时内预计释放的资源',
    unoccupiedList: '未占用',
    unoccupiedListHint: '当前无 lock 或 book 的资源',
    occupiedList: '已占用',
    occupiedListHint: '当前存在 lock 或 book 的资源',
    noUnoccupied: '当前没有未占用资源',
    noOccupied: '当前没有已占用资源',
    moreResources: '另有 {count} 个',
    clickToDetails: '点击条目，直接展开对应开发机的卡片详情。',
    clickToQueueDetails: '点击条目，直接定位并高亮对应节点的表格行。',
    soonestAvailable: '{time} 后可用',
    deviceMap: 'GPU 使用状态分布',
    showDeviceDetails: '查看 {count} 张卡详情',
    deviceDetails: '{count} 张卡的占用详情',
    resourceStatus: '资源状态',
    machineOverview: '机器概览',
    ipUnavailable: '未配置 IP 地址',
    modelUnavailable: '型号未知',
    memory: '显存',
    utilization: '利用率',
    status: '状态',
    noUser: '当前无人占用',
    noDeadline: '无时限',
    autoRefresh: '页面每 30 秒自动更新',
    overall: {
      healthy: '所有资源当前均未占用',
      partial: '部分资源当前已被占用',
      busy: '所有资源当前均被占用',
