export default {
  ...
  botCreate: {
    ...
    defaultDurationHelp:
      'Default duration when user does not specify, in hours. Default: 2 hours',
    maxLockDuration: 'Max Lock Duration',
    maxLockDurationHelp: 'Maximum allowed lock time in hours. -1 means unlimited.',
    maxLockDurationUnlimited: 'Unlimited (-1)',
    unlimited: 'Unlimited',
    hours: 'h',
    minutes: 'min',
    seconds: 's',
    maxLockDurationWarning: 'Over 24 hours may cause resources to be held for a long time',
    ...
    policyStartTime: 'Start Time',
    policyEndTime: 'End Time',
    policyWeekdays: 'Weekdays',
    weekdayMon: 'Mon',
    weekdayTue: 'Tue',
    weekdayWed: 'Wed',
    weekdayThu: 'Thu',
    ...
    weekdaySat: 'Sat',
    weekdaySun: 'Sun',
    policyEveryDay: 'Every day',
    lockPolicyDurationHours: 'Max Duration (hours)',
    ...
    invalidLockPolicyDuration: 'Policy maximum duration must be -1 or between 0.1 and 168 hours',
    invalidLockPolicyWeekdays: 'Select at least one unique weekday',
  ...
  publicReport: {
    ...
    unoccupied: 'Unoccupied resources',
    ...
    container: 'Container',
    live: 'Live report',
    machineReport: 'Machine status report',
    summary: 'Resource summary',
    totalHint: 'Resources in this public report',
    unlockedHint: '{percent}% of all resources',
    unoccupiedHint: 'No lock or booking; {percent}% of all resources',
    soonHint: 'Only resources with a known release time are included',
    gpuFreeHint: '{percent}% with free GPU memory',
    quickView: 'Quick view',
    availabilityOverview: 'Available resources at a glance',
    resourceUsageOverview: 'Resource occupancy at a glance',
    resourcesTracked: '{count} resources tracked',
    availableList: 'Available now',
    availableListHint: 'Unlocked resources that can be requested directly',
    soonList: 'Available soon',
    soonListHint: 'Expected to release within the next 2 hours',
    noAvailable: 'There are no resources immediately available',
    noSoon: 'No resource is expected to release within 2 hours',
    unoccupiedList: 'Unoccupied',
    unoccupiedListHint: 'Resources without a lock or booking',
    occupiedList: 'Occupied',
    occupiedListHint: 'Resources with a lock or booking',
    noUnoccupied: 'There are no unoccupied resources',
    noOccupied: 'There are no occupied resources',
    moreResources: '{count} more',
    clickToDetails: 'Click an item to open its development machine and card details.',
    clickToQueueDetails: 'Click an item to locate and highlight its node in the table.',
    soonestAvailable: 'Available in {time}',
    deviceMap: 'GPU usage status map',
    showDeviceDetails: 'View {count} card details',
    deviceDetails: 'Occupancy details for {count} cards',
    resourceStatus: 'Resource status',
    machineOverview: 'Machine overview',
    ipUnavailable: 'IP address unavailable',
    ...
    autoRefresh: 'This page updates every 30 seconds',
    overall: {
      healthy: 'All resources are currently unoccupied',
      partial: 'Some resources are currently occupied',
      busy: 'All resources are currently occupied',
      neutral: 'There are no resources to show yet',
    },
    statuses: {
      idle: 'Not reserved',
      free: 'Memory free',
      partial: 'Partially occupied',
      busy: 'High memory use',
      exclusive: 'Reserved exclusively',
      shared: 'Reserved jointly',
      na: 'Unknown',
    },
    usageStatuses: {
      idle: 'Idle',
      in_use: 'In use',
      partial: 'Partially in use',
      na: 'Not collected',
    },
  },
}
