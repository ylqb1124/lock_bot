...
- 监控节点范围以 `web/shared/cluster-scope.json` 为准。当前范围为 94 个计算节点、每节点 8 卡，共 752 卡；node13、node80、node81、node85、node86 从北京时间 2026-08-06 00:00 起生效，node53 从 2026-08-14 18:00 起生效，node95 至 node114 从 2026-08-21 00:00 起生效；BDC 节点不进入集群趋势分母。
